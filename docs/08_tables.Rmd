...
#   dplyr::filter(scientific_name %in% Benthic_Biomass_Species) %>% 
#   dplyr::select(common_name, scientific_name, targeted_broad, trophic_broad) %>% 
...
site_data <- Site_Info |>
  ...
  dplyr::select(SiteNumber, Island, IslandName, SiteCode, SiteName, 
                Reference, ReserveStatus, ARMs, ReserveYear,
